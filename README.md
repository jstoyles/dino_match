...
This app, besides being fun to play =), incorporates things like local caching, flip and fade animations, timers, data models with JSON string parsing, and a way to randomly select and sort "dino" images during game play. 
